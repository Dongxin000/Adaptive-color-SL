function [imOut] = segColorGridAndColorToLabel(imLight, imColorGrid, camCorners, hueLabel, verbose)
...
% enhance color
imColorGridMaskedWOEnhColor = imColorGridMasked;
...
% mask color grid
imColorGridMasked = ImgProc.maskImage(imColorGridMaskedWOEnhColor, imBWGrid);
